...
class SecureAgent:
    def __init__(self, name, system_prompt, debug_mode="true"):
        ...
        if name == "Alice":
            ...
            if debug_mode == "untrusted":
                self.cert = load_certificate("certs/alice_self_signed.cert.pem")  # Use self-signed for debug. Generated by Copilot
            else:
    ...
    def send_message(self, message, recipient_name, connection, use_web=False):
        ...
        if self.debug_mode == "invalid":
            # Deliberately tamper with the payload after signing. Generated by Copilot
...
if __name__ == "__main__":
    ...
    parser.add_argument("--debug", default="true", choices=["true", "untrusted", "invalid"], help="Set to 'untrusted' to use a self-signed cert, 'invalid' to tamper with the signature, or 'true' for normal operation. Generated by Copilot")
